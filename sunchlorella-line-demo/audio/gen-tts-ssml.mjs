...
const CHAPTERS = [
  { name: '01-issue', phrases: [
    ...
    // 3つの課題 概要 (列挙)
    { text: 'いま、 御社の 現場で 起きて いる 課題は、 大きく 3つ あります。' },
    { mark: 'agenda_intro' },
    { text: '1つ目は、 訪問販売員の 実績が、 EC化 に よって 消えて いく こと。' },
    { mark: 'agenda_1' },
    { text: '2つ目は、 4本の 公式LINE アカウントが 部署別 に 運用され、 本社が 数字を 横断把握 できない こと。' },
    { mark: 'agenda_2' },
    { text: '3つ目は、 中高齢の お客様の 半数が、 メール アドレス 入力で 離脱する こと。' },
    { mark: 'agenda_3' },
    { text: 'これから、 1つずつ、 場面と 数字で ご説明 します。' },
    { mark: 'agenda_end' },

    // 課題① 転入 + 見出し要約 + 詳細
    { text: 'まず、 1つ目。 訪問販売員の 実績が 消える、 について で ございます。' },
    { mark: 'issue1_intro' },
    { text: 'これは、 販売員が 玄関先で 積み上げた 信頼、 その 成果が、 お客様が オンラインで 買い物 した 瞬間、 EC部門の 実績として 計上 されてしまう、 という 問題 で ございます。' },
    { mark: 'issue1_topic' },
    { text: '具体的な 例で ご説明 します。' },
    { mark: 'issue1_before_scene' },
    { text: 'たとえば、 販売員 北野さんが、 3ヶ月 通って 信頼関係を 築いた 田中さま。' },
    { mark: 'issue1_scene_visit' },
    { text: '週末の 夜、 スマホで 定期便に お申し込みに なった 瞬間、' },
    { mark: 'issue1_scene_ec' },
    { text: 'その 売上は、 EC部門の 実績として 記録 されます。' },
    { mark: 'issue1_result' },
    { text: '北野さんの 3ヶ月の 努力は、 どこにも 残らない。' },
    { mark: 'issue1_end' },

    // 課題② 転入 + 見出し要約 + 詳細
    { text: '次に、 2つ目。 本社で 数字を 横断把握 できない、 について で ございます。' },
    { mark: 'issue2_intro' },
    { text: 'これは、 4本の 公式LINE アカウントが 部署ごと 別々に 運用 されて いる ため、 本社として 横断的な 数字が 見えない、 という 問題 で ございます。' },
    { mark: 'issue2_topic' },
    { text: '4本の LINE アカウントが、 部署ごと 別々の ツールで 運用 されて いる ため、' },
    { mark: 'issue2_dispatch' },
    { text: '本社 として、 各アカウントで、 どれだけの 数字が 動いて いるのか、 横断的 に 把握 できない。' },
    { mark: 'issue2_hq' },
    { text: '経営会議で、 「LINE経由 の 総売上、 総友達数、 平均開封率」 を 見たくても、 4部署から 数字を 集めて 手作業で 合算する 必要が あります。' },
    { mark: 'issue2_end' },

    // 課題③ 転入 + 見出し要約 + 詳細
    { text: '最後に、 3つ目。 中高齢の お客様が 離脱 する、 について で ございます。' },
    { mark: 'issue3_intro' },
    { text: 'これは、 御社の 中心顧客層 で ある 60代 70代 の 女性が、 ECサイトで メール登録を 求められた 瞬間、 半数が 諦めて しまう、 という 問題 で ございます。' },
    { mark: 'issue3_topic' },
    { text: '御社の 中心顧客層 で ある 中高齢の お客様は、 ECサイトで メール アドレス 入力を 求められた 瞬間、 半数が 購入を あきらめて しまう。' },
    { mark: 'issue3_scene' },
    { text: '販売員が いくら 「ECサイト、 ぜひ ご利用ください」 と ご案内 しても、 定期便の 追加購入 に つながらない。' },
    { mark: 'issue3_end' },

    // 統合LINE OS 提示 + 5つの機能 preview
    { text: 'これらの 3つの 課題を、 1つの 運用OS に まとめた のが、 統合LINE OS で ございます。' },
    { mark: 'solution_intro' },
    { text: 'この 統合LINE OS は、 5つの 機能で 構成 されて います。' },
    { mark: 'solution_five' },
    { text: '訪問販売員 実績。 4アカウント 統合。 LINE内 EC。 キャンペーン LTV。 シナリオ ビルダー。' },
    { mark: 'solution_list' },
    { text: '今 から、 それぞれ を、 順番に、 詳しく お話し します。' },
    { mark: 'solution_end' },
  ]},
  ...
  { name: '07-impact', phrases: [
    { text: '同規模の 健康食品 ブランド 事例では、 統合LINE OS 導入 から 6ヶ月後、 3つの 主要 数字 に、 明確な 変化が 出て います。' },
    { mark: 'title_end' },

    // 3つのKPI 概要 (列挙)
    { text: '1つ目は、 販売員 1人 あたり の 月次売上が、 平均で 18パーセント 増。' },
    { mark: 'agenda_1' },
    { text: '2つ目は、 定期便 の 半年 継続率が、 12ポイント 上昇。' },
    { mark: 'agenda_2' },
    { text: '3つ目は、 LINE 経由 の 購入 CVR が、 2倍 から 3倍。' },
    { mark: 'agenda_3' },
    { text: 'それぞれ、 なぜ この 数字が 出たのか、 順番に ご説明 します。' },
    { mark: 'agenda_end' },

    // KPI 1 転入 + 見出し要約 + 理由
    { text: 'まず、 1つ目。 販売員 月次売上 プラス 18パーセント、 について で ございます。' },
    { mark: 'kpi1' },
    { text: 'これは、 販売員 1人 あたりの 月次売上が、 導入前 と 比べて、 平均で 18パーセント 増加 した、 という 変化 で ございます。' },
    { mark: 'kpi1_topic' },
    { text: 'この 数字が 出た 理由は、 販売員の 担当顧客が、 EC や LINE で 追加購入 した 分も、 販売員実績 に 帰属する よう に なった ため。' },
    { mark: 'kpi1_reason' },
    { text: '「自分の 顧客が、 見えない ところ で も 買って くれて いる」、 この 実感 が、 販売員の モチベーション を 押し上げた 結果です。' },
    { mark: 'kpi1_end' },

    // KPI 2 転入 + 見出し要約 + 理由
    { text: '次に、 2つ目。 定期便 継続率 プラス 12ポイント、 について で ございます。' },
    { mark: 'kpi2' },
    { text: 'これは、 定期便の 半年 継続率が、 導入前 と 比べて、 12ポイント 上昇 した、 という 変化 で ございます。' },
    { mark: 'kpi2_topic' },
    { text: 'この 数字が 出た 理由は、 「解約」 タップ 前 の 引き止め シナリオ と、 定期便 スキップ の 1タップ 操作 に よって、 「面倒 だから やめる」 の 手前で、 継続 に 戻せた ため です。' },
    { mark: 'kpi2_reason' },

    // KPI 3 転入 + 見出し要約 + 理由
    { text: '最後に、 3つ目。 LINE 経由 CVR 2倍 から 3倍、 について で ございます。' },
    { mark: 'kpi3' },
    { text: 'これは、 LINE アプリ 経由 の 購入 CVR が、 従来 と 比べて、 2倍 から 3倍 に なった、 という 変化 で ございます。' },
    { mark: 'kpi3_topic' },
    { text: 'この 数字が 出た 理由は、 メール 登録 が 不要 に なり、 中高齢層 の 離脱 が 撤廃 された ため です。' },
    { mark: 'kpi3_reason' },
    ...
    { text: '月商 プラス 4.7億円、' },
    { mark: 'monthly' },
    { text: '年間で 約 56億円 の 売上 インパクト が、 想定 されます。' },
    { mark: 'end' },
  ]},
