...
(function () {
  ...
  // アンケート回答 デモ (v AV: q9〜q14 NEW項目入りサンプル / Firestore 実データが空の時のみ表示)
  window.SURVEY_DEMO = [
    {
      ts: '2026-06-08T10:15:00.000Z',
      userId: 'Udemo-survey-001-aaaa',
      displayName: '田中 健一',
      name: '田中 健一',
      q1_テーマ: '教育費・学資',
      q2_年代: '40代',
      q3_家族: '夫婦+子2人(8歳/5歳)',
      q4_年収: '700〜1000万',
      q5_悩み: '子供2人の大学進学費用が貯められるか不安。住宅ローンと重なる時期が心配。',
      q6_候補1: '2026-06-15 夜 19:00',
      q7_候補2: '2026-06-17 午後 14:00',
      q8_候補3: '2026-06-20 午前 10:00',
      q9_職業: '会社員(製造業)',
      q10_住居: '持家(ローン有)',
      q11_生年月日: '1983-04-12',
      q12_理想: '上の子が大学に入る頃までに1,000万円の教育資金。60歳で住宅ローン完済して年2回家族旅行できる暮らし。',
      q13_緊急度: 'すぐに相談したい',
      q14_既存商品: '終身保険(月15,000円)、新NISA(月50,000円)、医療保険(共済)',
      confirmedSlot: '',
    },
  ];
